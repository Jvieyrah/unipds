...
import com.eldermoraes.aula05.Ex2ForkJoinPoolsUsage.SumTask;
...
public class ForkJoinPoolsUsage {
  ...
  static class SumTask extends RecursiveTask<Long> {
    ...
    protected Long compute() {
      ...
      Ex2ForkJoinPoolsUsage.SumTask left = new Ex2ForkJoinPoolsUsage.SumTask(array, start, mid);
      Ex2ForkJoinPoolsUsage.SumTask right = new Ex2ForkJoinPoolsUsage.SumTask(array, mid, end);
      left.fork();
  ...
  long[] numbers = new long[1_000_000];
    ...
    long resultCommon = commonPool.invoke(new Ex2ForkJoinPoolsUsage.SumTask(numbers, 0, numbers.length));
    ...
    try (ForkJoinPool customPool = new ForkJoinPool(customParallelism)) {
      ...
      long resultCustom = customPool.invoke(new Ex2ForkJoinPoolsUsage.SumTask(numbers, 0, numbers.length));
